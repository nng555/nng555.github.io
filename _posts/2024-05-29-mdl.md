...
## MDL and pNML in Practice

If you've made it all the way to the end here, you might be asking why pNML and stochastic complexity might be useful outside of selecting a good model.
Here are a few ways MDL is useful in practice:
- **Uncertainty Calibration**: Since the 
- **Mislabel Detection**:
- **OOD Detection**:
