...
*This is part 2 of a blog post on our [**ICML 2024 paper**](/assets/files/stochastic_complexity.pdf). This one goes into the method itself, while [**part 1**](/blog/2024/05/29/mdl.html) goes into the background on the Minimum Description Length Principle
